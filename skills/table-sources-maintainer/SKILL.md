...
Source maps should use front matter with `managed_by: table-sources-maintainer`, a `maintainer_commit` field for the skill version used to maintain the file, and protected fields matching this skill's confirmation rules.
