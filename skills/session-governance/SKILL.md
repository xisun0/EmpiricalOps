...
- Get the live task inventory using the task-management tools. If complete project coverage matters, do not assume the sidebar/list response is exhaustive; use an available local task index read-only when it can supply the missing candidates.
